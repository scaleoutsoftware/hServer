...
/**
 * Test that uses the NamedMap for a MapReduce job's input and output with serializable objects.
 */
public class Test_NamedMapInputFormat_Serializables {
    ...
    public static void main(String argv[]) throws Exception {
        ...
        int numstrings = argv.length == 1 ? new Integer(argv[0]) : 10000000;
    ...
    public void runTest() throws Exception {
        (new Test_NamedMapInputFormat_Serializables()).main(new String[]{});
    }
}
